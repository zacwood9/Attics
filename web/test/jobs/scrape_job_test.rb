...
class ScrapeJobTest < ActiveJob::TestCase
  test "inserts and updates" do
    ...
    assert_difference %w[Performance.count Recording.count Track.count], 1 do
    ...
    assert_equal "06:10", new_recording.tracks.first.length
    assert_equal "Saturday Night", new_recording.tracks.first.title
